...
- `/styles` – Estilos personalizados y de Bootstrap
- `/multimedia` – Imágenes y recursos multimedia
- `/js` – Funcionalidad de JavaScript

## Contexto académico
- Módulo: Diseño de Páginas Web (DPW)
- Institución: ITCA-FEPADE
- Año: 2024
- Tipo de proyecto: Proyecto final académico (en equipo)

## Líder de equipo:
Alan Antonio Orellana Arguera
Alan Antonio Orellana Arguera
